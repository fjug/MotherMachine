...
public class SimpleFunctionAnalysis {
     ...
     * that have some minimal specified lateral extent (see monotonicity parameters '*FlankWidth').
     * @param fktValues - discrete double function values.
     * @param minLeftFlankWidth - a local maximum will only be considered if at least
     * the given number of lefthand values are strict monotone increasing towards the center.
     * @param minRightFlankWidth - a local maximum will only be considered if at least
     * the given number of righthand values are strict monotone decreasing.
     * @return
     */
    ...
    /** Takes double function values and returns the heights of all maxima and all minima
     * that have some minimal specified lateral extent (see monotonicity parameters '*FlankWidth').
     * @param fktValues - discrete double function values.
     * @param minLeftFlankWidth - a local maximum will only be considered if at least
     * the given number of lefthand values are strict monotone increasing towards the center.
     ...
     * @return
     */
    public static double[] getExteremalPointHeights(
	    final double[] fktValues, final int minLeftFlankWidth, final int minRightFlankWidth ) {
