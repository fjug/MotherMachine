...
public class GrowthLineFrame {
	...
	private class CompareComponentTreeNodes< T extends Type< T > > implements Comparator< ComponentTreeNode< T, ? > > {
		...
		@Override
		public int compare( final ComponentTreeNode< T, ? > o1, final ComponentTreeNode< T, ? > o2 ) {

			// FilteredComponentTreeNode
			if ( false || o1 instanceof FilteredComponentTreeNode< ? > && o2 instanceof FilteredComponentTreeNode< ? > ) { // igitt...
																															// instanceof!
				final FilteredComponentTreeNode< DoubleType > fc1 = ( FilteredComponentTreeNode< DoubleType > ) o1;
				final FilteredComponentTreeNode< DoubleType > fc2 = ( FilteredComponentTreeNode< DoubleType > ) o2;
			...
			return ( int ) ( o1.getSize() - o2.getSize() ) * -1;
		}
	}
	...
	private ComponentTree< DoubleType, ? > componentTree;
...
//		return getAvgXpos();
	...
	private double[] getIntensities( final Img< DoubleType > img ) {
	 ...
	 *         requested
	 */
	public List< ComponentTreeNode< DoubleType, ? > > getComponentHypothesis( final int numComponents ) {
		if ( componentTree == null ) return null;

		final PriorityQueue< ComponentTreeNode< DoubleType, ? > > queue = new PriorityQueue< ComponentTreeNode< DoubleType, ? > >( 1, new CompareComponentTreeNodes< DoubleType >() );
		final List< ComponentTreeNode< DoubleType, ? > > listNext = new LinkedList< ComponentTreeNode< DoubleType, ? > >();
		...
		while ( !listNext.isEmpty() ) {
			final ComponentTreeNode< DoubleType, ? > node = listNext.remove( 0 );
		...
		final ArrayList< ComponentTreeNode< DoubleType, ? > > ret = new ArrayList< ComponentTreeNode< DoubleType, ? > >( numComponents );
